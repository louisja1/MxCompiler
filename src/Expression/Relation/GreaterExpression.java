...
public class GreaterExpression extends BaseExpression {
    ...
    private GreaterExpression(BaseExpression _firstExpression, BaseExpression _secondExpression) {
    ...
    public static BaseExpression getExpression(BaseExpression _firstExpression, BaseExpression _secondExpression) {
        ...
        if (firstType == IntType.getInstance() && secondType == IntType.getInstance()) {
            ...
            return new GreaterExpression(_firstExpression, _secondExpression);
        }
        if (firstType == StringType.getInstance() && secondType == StringType.getInstance()) {
            ...
            return FunctionExpression.getExpression(IdentifierExpression.getExpression("_builtin_GR"), expressionList);
        }
        throw new CompilationError("There is an invalid greater expression");
    }
}
